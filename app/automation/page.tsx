...
export const metadata = {
  ...
  description: 'Automate repetitive tasks and streamline operations for UK and US businesses with smart workflow systems. Growth Leder builds scalable automation that saves time and increases efficiency.',
  keywords: 'business automation services, CRM automation, workflow automation, Zapier automation, process automation, UK business automation, US workflow automation',
  openGraph: {
    title: 'Smart Automation for Scalable Growth (UK & US)',
